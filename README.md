...
1. **Start the PartyKit server** (in one terminal):
```bash
bunx partykit dev
```
...
3. **Try the demos**:
   - Polls: `http://localhost:3000/demo/party/polls`
   - Kahoot Host: `http://localhost:3000/demo/party/kahoot-host`
   - Kahoot Player: `http://localhost:3000/demo/party/kahoot-player?room=<room-id>`

### Features

#### Real-time Polls
- Create polls with multiple options
- See votes update in real-time across all connected clients
- One vote per user
- Poll creator can end the poll

#### Kahoot-style Quiz Games
- Host creates games with multiple questions
- Players join with unique names
- Real-time gameplay with time-based scoring
- Live leaderboards and final rankings

### Documentation

For detailed information about PartyKit servers, see [party/README.md](./party/README.md).
